                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0)">Language <i class="fa fa-chevron-down"></i></a>
                                    <ul class="ht-dropdown">
                                        <li class="active"><a href="javascript:void(0)"><img src="{{asset('fornt-end-assets')}}/assets/images/menu/icon/1.jpg" alt="JB's Language Icon">English</a></li>
                                        <li><a href="javascript:void(0)"><img src="{{asset('fornt-end-assets')}}/assets/images/menu/icon/2.jpg" alt="JB's Language Icon">Français</a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="{{asset('fornt-end-assets')}}/assets/images/menu/logo/1.png" alt="Hiraola's Header Logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-9">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4 d-lg-none d-block">
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="{{asset('fornt-end-assets')}}/assets/images/menu/logo/2.png" alt="Hiraola's Header Logo">
                        </a>
                    </div>
                </div>
                ...
                <ul class="minicart-list">
                    <li class="minicart-product">
                        ...
                        <div class="product-item_img">
                            <img src="{{asset('fornt-end-assets')}}/assets/images/product/small-size/2-1.jpg" alt="Hiraola's Product Image">
                        </div>
                    ...
                    <li class="minicart-product">
                        <a class="product-item_remove" href="javascript:void(0)"><i class="ion-android-close"></i></a>
                        <div class="product-item_img">
                            <img src="{{asset('fornt-end-assets')}}/assets/images/product/small-size/2-2.jpg" alt="Hiraola's Product Image">
                        </div>
                        <div class="product-item_content">
                    ...
                    <li class="minicart-product">
                        <a class="product-item_remove" href="javascript:void(0)"><i class="ion-android-close"></i></a>
                        <div class="product-item_img">
                            <img src="{{asset('fornt-end-assets')}}/assets/images/product/small-size/2-3.jpg" alt="Hiraola's Product Image">
                        </div>
                        <div class="product-item_content">
