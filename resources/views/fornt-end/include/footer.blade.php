                ...
                <div class="col-lg-4">
                    <div class="footer-widgets_info">
                        ...
                        <div class="footer-widgets_logo">
                            <a href="#">
                                <img src="{{asset('fornt-end-assets')}}/assets/images/footer/logo/1.png" alt="Hiraola's Footer Logo">
                            </a>
                        </div>
            ...
            <div class="footer-bottom_nav">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="payment">
                            <a href="#">
                                <img src="{{asset('fornt-end-assets')}}/assets/images/footer/payment/1.png" alt="Hiraola's Payment Method">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
